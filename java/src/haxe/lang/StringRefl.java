...
public  class StringRefl
{
	...
	{
		{
			java.lang.String __temp_svar102 = (f);
			int __temp_hash104 = __temp_svar102.hashCode();
			boolean __temp_executeDef103 = true;
			switch (__temp_hash104)
			{
				case -1106363674:
				{
					if (__temp_svar102.equals("length")) 
					{
				...
				{
					if (( (( ( __temp_hash104 == 530542161 ) && __temp_svar102.equals("substring") )) || ( (( ( __temp_hash104 == -891529231 ) && __temp_svar102.equals("substr") )) || ( (( ( __temp_hash104 == 109648666 ) && __temp_svar102.equals("split") )) || ( (( ( __temp_hash104 == -467511597 ) && __temp_svar102.equals("lastIndexOf") )) || ( (( ( __temp_hash104 == 1943291465 ) && __temp_svar102.equals("indexOf") )) || ( (( ( __temp_hash104 == 397153782 ) && __temp_svar102.equals("charCodeAt") )) || ( (( ( __temp_hash104 == -1361633751 ) && __temp_svar102.equals("charAt") )) || ( (( ( __temp_hash104 == -1137582698 ) && __temp_svar102.equals("toLowerCase") )) || __temp_svar102.equals("toUpperCase") ) ) ) ) ) ) ) )) 
					{
						__temp_executeDef103 = false;
