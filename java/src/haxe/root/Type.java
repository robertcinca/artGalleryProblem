...
public  class Type extends haxe.lang.HxObject
{
	...
	public static   java.lang.String getClassName(java.lang.Class c)
	{
		...
		{
			java.lang.String __temp_svar48 = (name);
			...
			switch (__temp_hash50)
			{
				...
				{
					if (( (( ( __temp_hash50 == -672261858 ) && __temp_svar48.equals("Integer") )) || __temp_svar48.equals("int") )) 
					{
				...
				case -1939501217:
				{
					if (__temp_svar48.equals("Object")) 
					{
						__temp_executeDef49 = false;
						return "Dynamic";
					}
				...
				{
					if (( (( ( __temp_hash50 == 2052876273 ) && __temp_svar48.equals("Double") )) || __temp_svar48.equals("double") )) 
					{
						__temp_executeDef49 = false;
						return "Float";
					}
